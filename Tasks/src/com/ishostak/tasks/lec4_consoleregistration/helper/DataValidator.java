...
public class DataValidator {
    ...
    public static final String FIRST_NAME_PATTERN = "^[A-ZА-Я][a-zа-я]{2,30}$";
    public static final String LAST_NAME_PATTERN = "^[A-ZА-Я][a-zа-я]{2,30}$";
    public static final String EMAIL_PATTERN = "^[\\w-\\.]+@([\\w-]+\\.)+[\\w-]{2,4}$";
    public static final String NICKNAME_PATTERN ="^[a-z]{6,20}$";
    public static final String SURNAME_PATTERN = "^[A-ZА-Я][a-zа-я]{2,30}$";
